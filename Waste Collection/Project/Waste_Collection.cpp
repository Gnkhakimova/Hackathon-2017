...
void floydwarshall(int **graph, int dimension, vector<int>** actual_path,int start, int end, ofstream& outfile, int *waste)
{
...
int main()
{
	...
	floydwarshall(graph_distance, dimensions,actual_path,start,end,outfile,full_waste);
	return 0;
}
